...
/** * Created by zzb on 2017/11/3.
 */

public class PermissionUtils {

    public static boolean permissionDialogFirstShow(Context context,String permission){
        SharedPreferences sp = 	context.getSharedPreferences("preference_check_permission",Context.MODE_PRIVATE);
        return sp.getBoolean("is_first_show_"+permission+"_permission_dialog",true);
    }
    public static void setPermissionDialogShown(Context context,String permission){
        SharedPreferences sp = 	context.getSharedPreferences("preference_check_permission",Context.MODE_PRIVATE);
        sp.edit().putBoolean("is_first_show_"+permission+"_permission_dialog",false).commit();
    }
    /**
     * 检测权限
     *
